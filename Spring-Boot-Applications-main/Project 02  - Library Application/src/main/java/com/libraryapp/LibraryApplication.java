...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "gajendrakulkarni7057@gmail.com", "Gajendra", "Kulkarni", "Huizumerlaan 158", "06-11433823", "Amsterdam");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "librarian@gamail.com", "Librarian", " ", "Hugo de Grootstraat 174", "06-87054875", "Sliedrecht");
			...
			book10.setReturnDate(LocalDate.of(2023, 5, 25));
			
			book1.setTheUser(user3);
			book1.setReturnDate(LocalDate.of(2023, 5, 07));
